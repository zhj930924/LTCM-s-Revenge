...
Partial Public NotInheritable Class Markets
    ...
    Friend WithEvents StockIndexLO As Microsoft.Office.Tools.Excel.ListObject
    ...
    Private Sub InitializeControls()
        Me.StockMarketLO = Globals.Factory.CreateListObject(Nothing, Nothing, "Sheet4:StockMarketLO", "StockMarketLO", Me)
        Me.OptionMarketLO = Globals.Factory.CreateListObject(Nothing, Nothing, "Sheet4:OptionMarketLO", "OptionMarketLO", Me)
        Me.StockIndexLO = Globals.Factory.CreateListObject(Nothing, Nothing, "Sheet4:StockIndexLO", "StockIndexLO", Me)
    End Sub
    ...
    Private Sub InitializeComponents()
        ...
        'StockIndexLO
        '
        Me.StockIndexLO.DefaultDataSourceUpdateMode = System.Windows.Forms.DataSourceUpdateMode.Never
        '
        'Markets
        '
    End Sub
